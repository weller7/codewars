// Task
// Many people choose to obfuscate their email address when displaying it on the Web. One common 
// way of doing this is by substituting the @ and . characters for their literal equivalents in brackets.
...
// email address string and returns the obfuscated version as a string that replaces the 
// characters @ and . with [at] and [dot], respectively.
...
obfuscate = function(email) {
  ...
  obfuscate("Jamie.O'Hare@mail.uk")